        ...
        <div class="bottom-row">
          ...
          <div class="quick-actions-card">
            ...
            <div class="actions-grid">
              ...
              <button class="action-item">
                <span class="action-icon action-icon-green">
                  <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
              ...
              <button class="action-item">
                <span class="action-icon action-icon-orange">
                  <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
...
<style scoped>
/* ===================================
   Dashboard Layout - Enterprise Style
   =================================== */
...
.action-icon-blue { color: #3B82F6; background: rgba(59, 130, 246, 0.1); }
.action-icon-green { color: #22C55E; background: rgba(34, 197, 94, 0.1); }
.action-icon-purple { color: #8B5CF6; background: rgba(139, 92, 246, 0.1); }
.action-icon-orange { color: #F59E0B; background: rgba(245, 158, 11, 0.1); }
